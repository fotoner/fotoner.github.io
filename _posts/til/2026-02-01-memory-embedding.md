...
last_modified_at: 2026-02-01T16:24:00
categories: 
  - TIL
tags:
  - AI
...
기존에는 AI 에이전트(코토네)가 메모리를 텍스트 파일로만 저장하고 있었다.
...
```markdown
검색어: "Proxmox LXC 브라우저"
→ 어제 작업한 AppArmor 설정 내용이 정확히 검색됨!
→ 점수: 0.67 (가장 높음)
```
...
- [OpenClaw Memory Search 도구](https://docs.openclaw.ai)
